                                            ...
                                            <div className="p-4 flex flex-col flex-1">
                                                ...
                                                <div className="mt-auto flex items-center justify-between">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`h-11 px-5 rounded-xl font-bold text-sm flex items-center gap-2 transition-all shadow-sm active:scale-95 ${product.stock_control.available_pieces <= 0
